...
<div id="container">
    ...
    <form id='HrManager' method='post' name='HrManager' action='save' charset='utf-8' enctype="multipart/form-data">
        ...
        <table>
            <c:if test="${bean.id != null}"><tr><td><fmt:message key='id'/></td><td>${bean.id}</td></tr></c:if>
                ...
                <td>
                    ...
                    <div class='errorMessage'>${messageMap.sex}</div></td></tr>  
            ...
            <tr><td><label for='patronicNameEn'><fmt:message key='patronicNameEn'/></label></td>
                <td><input maxlength='40' id='patronicNameEn' type='text' name='patronicNameEn' size='40' value='${bean.patronicNameEn}'/>
            ...
            <tr><td><label for='emailOffice'><fmt:message key='emailOffice'/></label></td>
                <td><input required='required' class='inpReq' maxlength='40' id='emailOffice' type='email' name='emailOffice' size='40' value='${bean.emailOffice}'/>
                    <div class='errorMessage'>${messageMap.emailOffice}</div></td></tr>
            <tr><td><label for='emailHome'><fmt:message key='emailHome'/></label></td>
                <td><input required='required' class='inpReq' maxlength='40' id='emailHome' type='email' name='emailHome' size='40' value='${bean.emailHome}'/>
                    <div class='errorMessage'>${messageMap.emailHome}</div></td></tr>
            <tr><td><label for='emailAdd'><fmt:message key='emailAdd'/></label></td>
                <td><input maxlength='40' id='emailAdd' type='email' name='emailAdd' size='40' value='${bean.emailAdd}'/>
        ...
        <input type='hidden' name='required' value='<%="sex:reqTrue:typeText^"
                ...
                + "patronicNameEn:reqFalse:typeText^"
